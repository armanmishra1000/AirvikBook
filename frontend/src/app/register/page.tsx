  ...
  return (
    <div className="min-h-screen bg-airvik-white dark:bg-gray-900 flex items-center justify-center px-space-4 pb-6">
      <div className="max-w-md w-full">
        {registrationSuccess ? (
          <div className="bg-airvik-white dark:bg-gray-800 rounded-radius-lg sm:shadow-lg sm:p-space-8 sm:card-auth text-center">
            <div className="flex items-center justify-center sm:size-16 size-12 mx-auto mb-space-4 bg-success/10 rounded-radius-full">
              <svg className="w-8 h-8 text-success" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
            </div>
            <h2 className="sm:text-h2 text-h3 font-sf-pro text-airvik-black dark:text-airvik-white mb-space-2">
              Account Created Successfully!
            </h2>
            <p className="text-gray-600 text-body dark:text-gray-400 mb-space-2">
              We've sent a verification email to <strong>{userEmail}</strong>
            </p>
            <div className="flex items-center justify-center">
              <div className="w-5 h-5 rounded-radius-full" />
