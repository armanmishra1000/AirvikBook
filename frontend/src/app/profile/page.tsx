        ...
        <div className="relative overflow-hidden">
          ...
          <div className="container mx-auto px-space-4 pt-space-8 lg:pt-space-12 pb-space-6 lg:pb-space-8">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-space-4 lg:gap-space-6">
              ...
              <Link 
                href="/dashboard" 
                className="group inline-flex items-center gap-space-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-space-4 py-space-3 rounded-radius-lg shadow-shadow-sm hover:shadow-shadow-md border border-gray-200 dark:border-gray-700 self-start lg:self-auto"
              >
                ...
                <div className="bg-white border border-gray-100 dark:bg-gray-800 rounded-radius-xl shadow-shadow-sm dark:border-gray-700 p-space-4 lg:p-space-6">
                  ...
                  <div className="space-y-space-4">
                    ...
                    <div className="flex items-center justify-between py-space-2">
                      <div className="flex items-center space-x-space-2">
                        <div className="w-4 h-4 bg-white rounded-radius-sm flex items-center justify-center shadow-shadow-sm">
